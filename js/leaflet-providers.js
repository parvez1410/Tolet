(function (root, factory) {
	 ...
	 * see http://leafletjs.com/reference.php#tilelayer for options in the options map.
	 */
	...
	L.TileLayer.Provider.providers = {
		...
		OpenInfraMap: {
			...
			options: {
				maxZoom: 18,
				attribution:
					'{attribution.OpenStreetMap}, <a href="http://www.openinframap.org/about.php">About OpenInfraMap</a>'
			},
			variants: {
				Power: 'power',
				Telecom: 'telecoms',
		...
		NLS: {
			...
			// http://maps.nls.uk/projects/api/index.php
